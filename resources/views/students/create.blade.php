...
<style>
    ...
    .live-preview-box { display: none; width: 80px; height: 80px; border-radius: 50%; object-fit: cover; border: 3px solid #ffffff; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
        ...
        <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid-row">
                <div class="input-field-group">
                    ...
                    <input type="text" id="firstname" name="firstname" class="custom-input" placeholder="e.g. John" value="{{ old('firstname') }}" maxlength="50" required>
                    @error('firstname') <span class="error-inline-msg">{{ $message }}</span> @enderror
                </div>
                <div class="input-field-group">
                    <label for="lastname">Last Name</label>
                    <input type="text" id="lastname" name="lastname" class="custom-input" placeholder="e.g. Doe" value="{{ old('lastname') }}" maxlength="50" required>
            ...
            <div class="form-grid-row">
                <div class="input-field-group">
                    ...
                    <input type="date" id="birthday" name="birthday" class="custom-input" value="{{ old('birthday') }}" required>
                ...
                <div class="input-field-group">
                    ...
                    <div class="image-upload-zone" onclick="document.getElementById('profile_image').click()">
                        <div id="upload-zone-prompt">
                            ...
                            <span style="font-size: 13px; color: #4b5563; font-weight: 500;">Click to select profile photo</span>
                        </div>
                        <img id="image-live-preview" class="live-preview-box" alt="File Preview">
            ...
            <div class="form-grid-row">
                <div class="input-field-group">
                    ...
                    <input type="text" id="school" name="school" class="custom-input" placeholder="e.g. College of Engineering" value="{{ old('school') }}" maxlength="50" required>
                ...
                <div class="form-grid-row" style="margin-bottom: 0; gap: 16px;">
                    <div class="input-field-group">
                        ...
                        <input type="text" id="program" name="program" class="custom-input" placeholder="e.g. BSCS" value="{{ old('program') }}" maxlength="10" required>
                        @error('program') <span class="error-inline-msg">{{ $message }}</span> @enderror
                    </div>
                    <div class="input-field-group">
                        <label for="year">Curriculum Year</label>
                        <input type="number" id="year" name="year" class="custom-input" placeholder="1" value="{{ old('year') }}" min="1" max="10" required>
            ...
            <div class="form-grid-row">
                <div class="input-field-group">
                    ...
                    <input type="text" id="province" name="province" class="custom-input" placeholder="e.g. Metro Manila" value="{{ old('province') }}" maxlength="50" required>
                    @error('province') <span class="error-inline-msg">{{ $message }}</span> @enderror
                </div>
                <div class="input-field-group">
                    <label for="country">Country</label>
                    <input type="text" id="country" name="country" class="custom-input" placeholder="e.g. Philippines" value="{{ old('country') }}" maxlength="50" required>
                    @error('country') <span class="error-inline-msg">{{ $message }}</span> @enderror
                </div>
            </div>

            <div class="form-buttons-action-row">
                <a href="{{ route('students.index') }}" class="btn btn-secondary" style="padding: 12px 24px;">Cancel</a>
                <button type="submit" class="btn btn-primary" style="padding: 12px 28px; background-color: #10b981;">💾 Save Student Record</button>
            </div>
        </form>
    </div>
